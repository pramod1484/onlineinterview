...
class ArrayInputTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testParse()
    {
        ...
        try {
            $input = new ArrayInput(array('foo' => 'foo'), new InputDefinition(array(
                new InputArgument('name'))));
        ...
        $input = new ArrayInput(array('--foo' => 'bar'), new InputDefinition(array(
            new InputOption('foo'))));
        ...
        $input = new ArrayInput(array('--foo' => null), new InputDefinition(array(
            new InputOption('foo', 'f', InputOption::VALUE_OPTIONAL, '', 'default'))));
        ...
        $input = new ArrayInput(array('-f' => 'bar'), new InputDefinition(array(
