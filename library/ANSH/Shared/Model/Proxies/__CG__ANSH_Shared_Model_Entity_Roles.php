 ...
 */
class ANSH_Shared_Model_Entity_Roles extends \ANSH_Shared_Model_Entity_Roles implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'roleName', 'isEnabled', 'createdDate', 'modifiedDate');
    }
