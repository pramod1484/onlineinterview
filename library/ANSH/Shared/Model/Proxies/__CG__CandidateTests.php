 ...
 */
class CandidateTests extends \CandidateTests implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function setCandidate(\Users $candidate = NULL)
    {
        $this->__load();
    ...
    public function setCheckedBy(\Users $checkedBy = NULL)
    {
        $this->__load();
    ...
    {
        return array('__isInitialized__', 'id', 'remark', 'startTime', 'endTime',
            'totalMarks', 'createdDate', 'modifiedDate', 'candidate', 'test', 'checkedBy');
    }
