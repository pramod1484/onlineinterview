 ...
 */
class Candidates extends \Candidates implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function setJobPosition(\JobPositions $jobPosition = NULL)
    {
        $this->__load();
    ...
    {
        return array('__isInitialized__', 'id', 'dateOfBirth', 'degree', 'referedBy',
            'experience', 'mobileNo', 'noticePeriod', 'locality', 'createdDate',
            'modifiedDate', 'user', 'city', 'jobPosition', 'technology');
    }
