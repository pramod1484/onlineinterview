...
!function() {
    ...
    qq.basePublicApi = {log: function(a, b) {
        ...
        }}, qq.basePrivateApi = {_initFormSupportAndParams: function() {
            ...
            a.size >= 0 ? d = a.size : a.blob && (d = a.blob.size), c = this._uploadData.addFile(e, f, d), this._handler.add(c, a), this._trackButton(c), this._netUploadedOrQueued++, b.push({id: c, file: a})
            ...
            var c = this, d = this._uploadData.retrieve({status: [qq.status.UPLOADING, qq.status.UPLOAD_RETRYING, qq.status.QUEUED, qq.status.SUBMITTING, qq.status.SUBMITTED, qq.status.PAUSED]}).length;
    ...
    function r(a, b, c, d, e) {
        v[a] = {addToPath: b, additionalParams: c, additionalHeaders: d, payload: e};
        var f = u.push(a);
        return f <= w.maxConnections ? j(a) : void 0
    }
    var s, t, u = [], v = {}, w = {validMethods: ["POST"], method: "POST", contentType: "application/x-www-form-urlencoded", maxConnections: 3, customHeaders: {}, endpointStore: {}, paramsStore: {}, mandatedParams: {}, allowXRequestedWithAndCacheControl: !0, successfulResponseCodes: {DELETE: [200, 202, 204], POST: [200, 204], GET: [200]}, cors: {expected: !1, sendCredentials: !1}, log: function() {
        }, onSend: function() {
        }, onComplete: function() {
        }, onProgress: null};
    ...
    var f = a.options, g = this, h = a.proxy, i = qq.getUniqueId(), j = {}, k = {}, l = {}, m = f.isCors, n = {}, o = f.inputName, p = h.onCancel, q = h.onUuidChanged, r = h.getName, s = h.getUuid, t = h.log, u = new qq.WindowReceiveMessage({log: t});
    qq.extend(this, {add: function(a, b) {
            n[a] = {input: b}, b.setAttribute("name", o), b.parentNode && qq(b).remove()
        }, getInput: function(a) {
            return n[a].input
        }, isValid: function(a) {
            ...
            m ? c(a, b) : k[a.id] = qq(a).attach("load", function() {
                if (t("Received response for " + a.id), a.parentNode) {
                    try {
                        ...
                        t("Error when attempting to access iframe during handling of upload response (" + c.message + ")", "error"), d = {success: !1}
                    }
                    b(d)
                }
            })
    ...
    qq.extend(this, {add: function(a, b) {
            ...
            return{part: c, start: i, end: j, count: k, blob: b(g, i, j), size: j - i}
    ...
    function c(a, b) {
        ...
        try {
            ...
            k("Error when attempting to parse form upload response (" + g.message + ")", "error"), c = {success: !1}
        }
        return c
    }
    function d(b, c) {
        var d = a.paramsStore.get(b), f = a.demoMode ? "GET" : "POST", g = a.endpointStore.get(b), j = h(b);
        return d[a.uuidName] = i(b), d[a.filenameParam] = j, e._initFormForUpload({method: f, endpoint: g, params: d, paramsInBody: a.paramsInBody, targetName: c.name})
    }
    var e = this, f = b.onUploadComplete, g = b.onUuidChanged, h = b.getName, i = b.getUuid, j = f, k = b.log;
    qq.extend(this, new qq.AbstractUploadHandlerForm({options: {isCors: a.cors.expected, inputName: a.inputName}, proxy: {onCancel: a.onCancel, onUuidChanged: g, getName: h, getUuid: i, log: k}})), qq.extend(this, {upload: function(b) {
    ...
    function v(a) {
        ...
        if (h) {
            if (b = h.split(K), 5 === b.length)
                return c = b[0], d = parseInt(b[1], 10), e = parseInt(b[2], 10), f = parseInt(b[3], 10), g = parseInt(b[4], 10), {uuid: c, part: d, lastByteSent: e, initialRequestOverhead: f, estTotalRequestsSize: g};
    ...
    D = c(), qq.extend(this, new qq.AbstractUploadHandlerXhr({options: {chunking: L ? a.chunking : null}, proxy: {onUpload: C, onCancel: a.onCancel, onUuidChanged: F, getName: G, getSize: I, getUuid: H, log: J}})), qq.override(this, function(b) {
    ...
    qq.extend(d, a), c = qq.extend(this, new qq.AjaxRequester({validMethods: ["POST", "DELETE"], method: d.method, endpointStore: d.endpointStore, paramsStore: d.paramsStore, mandatedParams: b(), maxConnections: d.maxConnections, customHeaders: d.customHeaders, demoMode: d.demoMode, log: d.log, onSend: d.onDelete, onComplete: d.onDeleteComplete, cors: d.cors})), qq.extend(this, {sendDelete: function(a, b, e) {
            var f = e || {};
    ...
    qq.extend(d, a), c = qq.extend(this, new qq.AjaxRequester({validMethods: ["GET"], method: "GET", endpointStore: {get: function() {
                return d.endpoint
