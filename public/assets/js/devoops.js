...
function LoadCalendarScript(callback) {
    function LoadFullCalendarScript() {
        if (!$.fn.fullCalendar) {
            $.getScript(baseUrl + '/assets/plugins/fullcalendar/fullcalendar.js', callback);
        }
        else {
    ...
    if (!$.fn.moment) {
        $.getScript(baseUrl + '/assets/plugins/moment/moment.min.js', LoadFullCalendarScript);
    }
    else {
...
//
//  Dynamically load ckEditor plugin
//  homepage: http://datatables.net v1.9.4 license - GPL or BSD
//
function LoadCkEditorScript(callback) {
    if (!$.fn.CKEDITOR) {
        $.getScript(baseUrl + '/assets/ckeditor/ckeditor.js', callback);
    }
    else {
        if (callback && typeof (callback) === "function") {
            callback();
...
function LoadFineUploader(callback) {
    if (!$.fn.fineuploader) {
        $.getScript(baseUrl + '/assets/plugins/fineuploader/jquery.fineuploader-4.3.1.min.js', callback);
    }
    else {
        if (callback && typeof (callback) === "function") {
            callback();
...
function LoadXChartScript(callback) {
    function LoadXChart() {
        $.getScript(baseUrl + '/assets/plugins/xcharts/xcharts.min.js', callback);
    }
    function LoadD3Script() {
        if (!$.fn.d3) {
            $.getScript(baseUrl + '/assets/plugins/d3/d3.v3.min.js', LoadXChart)
        }
        else {
            LoadXChart();
        }
...
function LoadFlotScripts(callback) {
    function LoadFlotScript() {
        $.getScript(baseUrl + '/assets/plugins/flot/jquery.flot.js', LoadFlotResizeScript);
    }
    function LoadFlotResizeScript() {
        $.getScript(baseUrl + '/assets/plugins/flot/jquery.flot.resize.js', LoadFlotTimeScript);
    }
    function LoadFlotTimeScript() {
        $.getScript(baseUrl + '/assets/plugins/flot/jquery.flot.time.js', callback);
    }
    if (!$.fn.flot) {
        LoadFlotScript();
    }
...
function LoadMorrisScripts(callback) {
    function LoadMorrisScript() {
        if (!$.fn.Morris) {
            $.getScript(baseUrl + '/assets/plugins/morris/morris.min.js', callback);
        }
        else {
            if (callback && typeof (callback) === "function") {
                callback();
    ...
    if (!$.fn.raphael) {
        $.getScript(baseUrl + '/assets/plugins/raphael/raphael-min.js', LoadMorrisScript);
    }
    else {
        LoadMorrisScript();
    }
...
function LoadKnobScripts(callback) {
    if (!$.fn.knob) {
        $.getScript(baseUrl + '/assets/plugins/jQuery-Knob/jquery.knob.js', callback);
    }
    else {
        if (callback && typeof (callback) === "function") {
            callback();
...
function LoadSparkLineScript(callback) {
    if (!$.fn.sparkline) {
        $.getScript(baseUrl + '/assets/plugins/sparkline/jquery.sparkline.min.js', callback);
    }
    else {
        if (callback && typeof (callback) === "function") {
            callback();
...
function TestTable1() {
    $('#datatable-1').dataTable({
        ...
        "oLanguage": {
            "sSearch": "",
            "sLengthMenu": '_MENU_',
            "sEmptyTable": "<div class='text-center text-danger'>No record found</div>" 
        }
    });
}
//
...
/*-------------------------------------------
 ...
 ---------------------------------------------*/
                                //
// question category  form validator function
//
function categoryFormValidator() {
    $('#categoryForm').bootstrapValidator({
        ...
        fields: {
            categoryName: {
                ...
                message: 'The time to finish category is not valid',
                validators: {
                    notEmpty: {
                        message: 'The time to finish category is required and can\'t be empty'
                    },
                    regexp: {
                        regexp: /^[0-9]+$/,
                        message: 'The time to finish category can only consist of number'
                    }, lessThan: {
                        value: 120,
                        inclusive: true,
                        message: 'The time to finish category has to be between 5 to 120'
                    },
                    greaterThan: {
                        value: 5,
                        inclusive: false,
    ...
    $('#testForm').bootstrapValidator({
        ...
        fields: {
            testName: {
                validators: {
                    notEmpty: {
                        message: 'The test name is required and can\'t be empty'
                    }
                }
            },technology: {
                validators: {
                    notEmpty: {
                        message: 'The technology for question should be selected'
                    }
                }
            },
            category : {
                validators: {
                    ...
                    notEmpty: {
                        message: 'The category for question should be selected'
                    }
                }
            },
        }
...
// question form validator function
//
    ...
    $('#questionForm').bootstrapValidator({
        ...
        fields: {
            categoryId: {
                ...
                validators: {
                    notEmpty: {
                        message: 'The marks for question should be selected'
                    }
                }
            },
            questionType: {
                validators: {
                    notEmpty: {
                        message: 'The question type for question should be selected'
                    }
                }
            },
//            question: {
    ...
    $('#defaultForm').bootstrapValidator({
        ...
        fields: {
            ...
            position: {
                validators: {
                    notEmpty: {
                        message: 'The job position should be selected'
                    }
                }
            },
            test : {
                validators: {
                    notEmpty: {
                        message: 'The test should be selected'
                    }
                }
            },
            country: {
