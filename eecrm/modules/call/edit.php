    ...
    <div id="main">
        ...
        <div class="body">
            <div class="edit" id="call-edit">
                <form id="form-call-edit" name="frmEditCall" id="frmCreateCall" action="<?php echo BASEPATH; ?>modules/call/save.php" method="POST">
                <div class="detail-button-container button-container record-buttons">
                    <button class="btn btn-primary" data-action="save" type="submit">Save</button>
                    <a type="button" href="<?php echo BASEPATH; ?>modules/call/view.php?id=<?php echo $callDetails['id']; ?>" data-action="cancel" class="btn btn-default">Cancel</a>
                </div>
                                        ...
                                        <div class="row">
                                            <div class="cell cell-name  col-sm-6  form-group">
                                                ...
                                                <div class="field field-name">
                                                    <input type="text" class="main-element form-control" name="name" value="<?php echo sanitizeString($callDetails['name']); ?>">
                                                </div>
                                            </div>
                                                ...
                                                <div class="field field-parent">
                                                    <div class="row">
                                                        ...
                                                        <div class="input-group col-sm-6 col-md-12">
                                                            <input class="main-element form-control" type="text" name="opportunity" id="opportunity" value="<?php echo sanitizeString($callDetails['oppName']); ?>" autocomplete="off">
                                                    ...
                                                    <input type="hidden" id="opportunityIds" name="opportunityIds" value="<?php echo sanitizeString($callDetails['oppId']); ?>">
                                                </div>
                                            </div>
                                        </div>			
                                            ...
                                            <div class="cell cell-status  col-sm-6  form-group">
                                                ...
                                                <div class="field field-status">
                                                    <select name="status" class="form-control main-element">
                                                        <?php echo htmlSelectOptions(meetingCallStatusOption(), $callDetails['status']); ?>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="cell cell-direction  col-sm-6  form-group"><a href="javascript:" class="pull-right inline-edit-link hide"><span class="glyphicon glyphicon-pencil"></span></a>
                                                ...
                                                <div class="field field-direction">
                                                    <select name="direction" class="form-control main-element"> 
                                                        <?php echo htmlSelectOptions(callDirectionOption(), (string)$callDetails['direction']); ?>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="cell cell-dateStart  col-sm-6  form-group">
                                                ...
                                                <div class="field field-dateStart">
                                                    ...
                                                    <div class="row">
                                                        <div class="input-group col-lg-6 col-md-6 col-sm-6 date" id="dp1" data-date="<?php echo getFormattedDate($callDetails['date_start'], "m/d/Y"); ?>" data-date-format="mm/dd/yyyy">
                                                            <input class="main-element form-control" type="text" name="date_start" value="<?php echo getFormattedDate($callDetails['date_start'], "m/d/Y"); ?>" autocomplete="off">
                                                        ...
                                                        <div class="input-group col-lg-6 col-md-6 col-sm-6">
                                                            <input class="form-control ui-timepicker-input" type="text" id="date_start-time" name="date_start-time" value="<?php echo getFormattedDate($callDetails['date_start'], "H:i"); ?>" autocomplete="off">
                                            ...
                                            <div class="cell cell-duration  col-sm-6  form-group"><a href="javascript:" class="pull-right inline-edit-link hide"><span class="glyphicon glyphicon-pencil"></span></a>
                                                ...
                                                <div class="field field-duration">
                                                    <select name="duration" class="form-control main-element">
                                                        <?php echo htmlSelectOptions(callDurationOption(), (string)$callDetails['duration']); ?>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="cell cell-description  col-sm-6  form-group">
                                                ...
                                                <div class="field field-description">
                                                    <textarea class="main-element form-control" name="description" rows="4"><?php echo sanitizeString($callDetails['description']); ?></textarea>
                                                </div>
                                            </div>
                                        ...
                                        <div class="cell cell-assignedUser form-group col-sm-6 col-md-12">
                                            ...
                                            <div class="field field-assignedUser">
                                                <div class="input-group">
                                                    <input class="main-element form-control" type="text" id="assignedUserName" name="assignedUserName" value="<?php echo sanitizeString($callDetails['firstName'])." ".sanitizeString($callDetails['lastName']); ?>" autocomplete="off">
                                                    <span class="input-group-btn">        
                                                ...
                                                <input type="hidden" name="assignedUserId" id="assignedUserId" value="<?php echo $callDetails['assigned_user_id']; ?>">
                                            </div>
                                        </div>
                ...
                <input type="hidden" name="call" id="call" value="<?php echo $callDetails['id']; ?>" />
                </form>
