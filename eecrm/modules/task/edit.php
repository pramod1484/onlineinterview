    ...
    <div id="main">
        ...
        <div class="body">
            <div class="edit" id="task-edit">
                <form id="form-task-edit" name="frmEditTask" id="frmCreateTask" action="<?php echo BASEPATH; ?>modules/task/save.php" method="POST">
                <div class="detail-button-container button-container record-buttons">
                    <button class="btn btn-primary" data-action="save" type="submit">Save</button>
                    <a type="button" href="<?php echo BASEPATH; ?>modules/task/view.php?id=<?php echo $taskDetails['id']; ?>" data-action="cancel" class="btn btn-default">Cancel</a>
                </div>
                                        ...
                                        <div class="row">
                                            <div class="cell cell-name  col-sm-6  form-group">
                                                ...
                                                <div class="field field-name">
                                                    <input type="text" class="main-element form-control" name="name" value="<?php echo sanitizeString($taskDetails['name']); ?>">
                                                </div>
                                            </div>
                                                ...
                                                <div class="field field-parent">
                                                    <div class="row">
                                                        ...
                                                        <div class="input-group col-sm-6 col-md-12">
                                                            <input class="main-element form-control" type="text" name="opportunity" id="opportunity" value="<?php echo sanitizeString($taskDetails['oppName']); ?>" autocomplete="off">
                                                    ...
                                                    <input type="hidden" id="opportunityIds" name="opportunityIds" value="<?php echo sanitizeString($taskDetails['oppId']); ?>">
                                                </div>
                                            </div>
                                        </div>			
                                            ...
                                            <div class="cell cell-status  col-sm-6  form-group">
                                                ...
                                                <div class="field field-status">
                                                    <select name="status" class="form-control main-element">
                                                        <?php echo htmlSelectOptions(taskStatusOption(), $taskDetails['status']); ?>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="cell cell-priority  col-sm-6  form-group"><a href="javascript:" class="pull-right inline-edit-link hide"><span class="glyphicon glyphicon-pencil"></span></a>
                                                ...
                                                <div class="field field-priority">
                                                    <select name="priority" class="form-control main-element"> 
                                                        <?php echo htmlSelectOptions(taskPriorityOption(), $taskDetails['priority']); ?>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="cell cell-dateStart  col-sm-6  form-group">
                                                ...
                                                <div class="field field-dateStart">
                                                    ...
                                                    <div class="row">
                                                        <div class="input-group col-lg-6 col-md-6 col-sm-6 date" id="dp1" data-date="<?php echo getFormattedDate($taskDetails['date_start'], "m/d/Y"); ?>" data-date-format="mm/dd/yyyy">
                                                            <input class="main-element form-control" type="text" name="date_start" value="<?php echo getFormattedDate($taskDetails['date_start'], "m/d/Y"); ?>" autocomplete="off">
                                                        ...
                                                        <div class="input-group col-lg-6 col-md-6 col-sm-6">
                                                            <input class="form-control ui-timepicker-input" type="text" id="date_start-time" name="date_start-time" value="<?php echo getFormattedDate($taskDetails['date_start'], "H:i"); ?>" autocomplete="off">
                                            ...
                                            <div class="cell cell-dateEnd  col-sm-6  form-group">
                                                ...
                                                <div class="field field-dateEnd">
                                                    ...
                                                    <div class="row">
                                                        <div class="input-group col-lg-6 col-md-6 col-sm-6 date" id="dp2" data-date="<?php echo getFormattedDate($taskDetails['date_end'], "m/d/Y"); ?>" data-date-format="mm/dd/yyyy">
                                                            <input class="main-element form-control" type="text" name="date_end" value="<?php echo getFormattedDate($taskDetails['date_end'], "m/d/Y"); ?>" autocomplete="off">
                                                            <span class="input-group-btn add-on">        
                                                                <button type="button" class="btn btn-default" tabindex="-1">
                                                                    <i class="glyphicon glyphicon-calendar icon-calendar"></i>
                                                                </button>    
                                                        ...
                                                        <div class="input-group col-lg-6 col-md-6 col-sm-6">
                                                            <input class="form-control ui-timepicker-input" type="text" id="date_end-time" name="date_end-time" value="<?php echo getFormattedDate($taskDetails['date_end'], "H:i"); ?>" autocomplete="off">
                                                            <span class="input-group-btn dropdown">        
                                        ...
                                        <div class="row">
                                            <div class="cell cell-description  col-sm-6  form-group">
                                                ...
                                                <div class="field field-description">
                                                    <textarea class="main-element form-control" name="description" rows="4"><?php echo sanitizeString($taskDetails['description']); ?></textarea>
                                                </div>
                                            </div>
                                        ...
                                        <div class="cell cell-assignedUser form-group col-sm-6 col-md-12">
                                            ...
                                            <div class="field field-assignedUser">
                                                <div class="input-group">
                                                    <input class="main-element form-control" type="text" id="assignedUserName" name="assignedUserName" value="<?php echo sanitizeString($taskDetails['firstName'])." ".sanitizeString($taskDetails['lastName']); ?>" autocomplete="off">
                                                    <span class="input-group-btn">        
                                                ...
                                                <input type="hidden" name="assignedUserId" id="assignedUserId" value="<?php echo $taskDetails['assigned_user_id']; ?>">
                                            </div>
                                        </div>
                ...
                <input type="hidden" name="task" id="task" value="<?php echo $taskDetails['id']; ?>" />
                </form>
