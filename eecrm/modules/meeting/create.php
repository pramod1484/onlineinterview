    ...
    <div id="main">
        <div class="page-header">
            <div class="row">
                <div class="col-lg-7 col-sm-7">
                    <h3><a href="<?php echo BASEPATH; ?>modules/meeting/">Meetings</a> &raquo; create</h3>
                </div>
        ...
        <div class="body">
            <div class="edit" id="meeting-edit">
                <form id="form-meeting-edit" name="frmCreateMeeting" id="frmCreateMeeting" action="<?php echo BASEPATH; ?>modules/meeting/new.php" method="POST">
                <div class="detail-button-container button-container record-buttons">

                    <button class="btn btn-primary" data-action="save" type="submit">Save</button>
                    <a type="button" href="<?php echo BASEPATH; ?>modules/meeting/" data-action="cancel" class="btn btn-default">Cancel</a>
                </div>
