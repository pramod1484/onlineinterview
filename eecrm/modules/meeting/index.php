...
try {
    $meetings = getAllMeetings(0, MAX_ROWS);
} catch (Exception $exc) {
    ...
    <div id="main"><div class="page-header"><div class="row">
                ...
                <div class="col-lg-5 col-sm-5">
                    <div class="header-buttons btn-group pull-right">
                        <a class="btn btn-primary" href="<?php echo BASEPATH;?>modules/meeting/create.php">Create Meeting</a>
                    </div>
                </div>
            </div>
...
<!--                        <div class="input-group-btn">
                        ...
                        <div class="input-group-btn">
                            <button data-module="meeting" data-isadmin ="0" data-action="search" class="btn btn-primary search btn-icon" type="button" />
            ...
            <div class="list-buttons-container clearfix">
                <div class="btn-group actions">
                    ...
                    <ul class="dropdown-menu">
                        <li><a data-action="delete" data-isadmin="0" data-module="meeting" data-field="id" class="massremove" href="javascript:">Delete</a></li>
                ...
                <table class="table">
                    ...
                    <tbody>
                            <?php foreach ($meetings as $meeting): ?>
                                <tr data-id="<?php echo $meeting['id'];?>" class="initial">
                                    <td class="cell cell-checkbox">
                                        <input type="checkbox" data-id="<?php echo $meeting['id']; ?>" class="record-checkbox records-multiaction">
                                    </td>	
                                    <td class="cell cell-name">
                                        <a title="<?php echo sanitizeString($meeting['name']); ?>" data-id="<?php echo $meeting['id']; ?>" class="link" href="<?php echo BASEPATH;?>modules/meeting/view.php?id=<?php echo $meeting['id']; ?>"><?php echo sanitizeString($meeting['name']); ?></a>
                                    </td>	
                                    <td class="cell cell-status">
                                        <?php echo ($meeting['parent_id']) ? '<a data-id="' . $meeting['parent_id'] . '" class="link" href="' . BASEPATH . 'modules/opportunities/view.php?id=' . $meeting['parent_id'] . '">' . $meeting['oppName'] . '</a>' : ''?>
                                    </td>	
                                    <td class="cell cell-emailAddress">
                                        <span class="text-default"><?php echo sanitizeString($meeting['status']);?></span>
                                    </td>	
                                    <td class="cell cell-createdAt">
                                        <?php echo getFormattedDate($meeting['date_start'], "m/d/Y h:i")?>
                                    </td>	
                                    <td width="7%" class="cell cell-buttons">
                                        <a data-id="<?php echo $meeting['assigned_user_id']; ?>" class="link" href="<?php echo ADMINPATH;?>modules/users/view.php?id=<?php echo $meeting['assigned_user_id']; ?>"><?php echo sanitizeString($meeting['assignedUser']); ?></a>
                                    </td>	
                            </tr>                        
                            <?php endforeach; ?>
                    </tbody>
