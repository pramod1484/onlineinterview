...
if (!empty($_POST)) {
    ...
    if (!$response['valid']) {
        ...
        redirect('modules/meeting/edit.php?id=' . $_POST['meeting']);
    } else {
        $meetId = escapeString($_POST['meeting']);
        ...
        if (strtotime($date_end) < strtotime($date_start)) {
            ...
            redirect('modules/meeting/edit.php?id=' . $meetId);
            exit;
        }

        //$meetingPrevDetails = getMeetingDetails($meetId);
