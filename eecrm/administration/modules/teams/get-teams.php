        ...
        foreach ($teams as $team) { ?>
            <tr data-id="<?php echo $team['id']; ?>">
                <td class="cell cell-name">
                    <a title="<?php echo ucfirst(sanitizeString($team['name'])); ?>" data-id="<?php echo $team['id']; ?>" class="link selectthis" href="javascript:;"><?php echo ucfirst(sanitizeString($team['name'])); ?></a>
                </td>	
            </tr>            
<?php   }
    }
