...
<div class="container content">
    <div id="main">
        <div class="page-header">
            <div class="row">
                <div class="col-lg-7 col-sm-7">
                    <h3><a href="<?php echo ADMINPATH; ?>modules/sources/">Sources</a> &raquo; create</h3>
                </div>
        ...
        <div class="body">
            <div id="sources-edit" class="edit">
                <form id="form-sources-edit" name="frmSource" method="POST" action="<?php echo ADMINPATH; ?>modules/sources/new.php">
                <div class="detail-button-container button-container record-buttons">
                    <button type="submit" data-action="save" class="btn btn-primary">Save</button>		
                    <a href="<?php echo ADMINPATH; ?>modules/sources/" data-action="cancel" class="btn btn-default">Cancel</a>		
                </div>
