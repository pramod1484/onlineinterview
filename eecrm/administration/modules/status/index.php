...
$statusList = getAllStatus(0, MAX_ROWS);
?>
<div class="container content">
    <div id="main"><div class="page-header"><div class="row">
                <div class="col-lg-7 col-sm-7">
                    <h3><a href="<?php echo ADMINPATH; ?>">Administration</a> &raquo; Lead Status</h3>
                </div>
                <div class="col-lg-5 col-sm-5">
                    <div class="header-buttons btn-group pull-right">
                        <a class="btn btn-primary" href="<?php echo BASEPATH;?>administration/modules/status/create.php">Create Status</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="list-buttons-container clearfix">
                <div class="btn-group actions">
                    ...
                    <ul class="dropdown-menu">
                        <li><a data-action="delete" data-isadmin="1" data-module="status" data-field="id" class="massremove" href="javascript:">Delete</a></li>
                        <?php 
                                ...
                                foreach ($statusList as $status) : ?>
                                    <tr data-id="<?php echo $status['status_id'];?>" class="initial">
                                        ...
                                        <td class="cell cell-name">
                                            <a title="<?php echo ucfirst($status['status_name']);?>" data-id="<?php echo ucfirst($status['status_id']);?>" class="link" href="<?php echo ADMINPATH;?>modules/status/view.php?id=<?php echo $status['status_id'];?>">
                                        ...
                                        <td width="7%" class="cell cell-buttons">
                                            <div class="list-row-buttons btn-group pull-right">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    <li><a data-id="<?php echo $status['status_id']; ?>" data-action="quickEdit" class="action" href="<?php echo ADMINPATH; ?>modules/status/edit.php?id=<?php echo $status['status_id']; ?>">Edit</a></li>
