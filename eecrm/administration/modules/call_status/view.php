...
if (!empty($_GET['id'])) {
    $statusDetails = getCallStatusDetails($_GET['id']);
}
?>
    ...
    <div id="main">
        <div class="page-header"><div class="row">
                <div class="col-lg-7 col-sm-7">
                    <h3><a href="<?php echo ADMINPATH;?>modules/call_status/">Call Status</a> <?php if($statusDetails != NULL):?> &raquo; <?php echo $statusDetails['status_name']; endif;?></h3>
                </div>
        ...
        <div class="body"><div id="status-detail" class="detail">
                <div class="detail-button-container button-container record-buttons">
                    <a href="<?php echo ADMINPATH?>modules/call_status/edit.php?id=<?php echo $statusDetails['status_id'];?>" data-action="edit" class="btn btn-primary">Edit</a>
                    <a data-module='call_status' data-isadmin ='1' data-field='status_id' data-value='<?php echo $statusDetails['status_id'];?>' data-action="delete" class="btn btn-danger delete-record">Delete</a>
