    ...
    <div id="main">
        ...
        <div class="body">
            <div id="user-edit" class="edit">
                <form id="form-status-edit" name="statusEditForm" action="<?php echo ADMINPATH;?>modules/call_status/save.php" method="POST">
                <div class="detail-button-container button-container record-buttons">
                    <button type="submit" data-action="save" class="btn btn-primary">Save</button>		
                    <a href="<?php echo ADMINPATH;?>modules/call_status/view.php?id=<?php echo $statusDetails['status_id']; ?>" data-action="cancel" class="btn btn-default">Cancel</a>		
                </div>
