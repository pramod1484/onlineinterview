...
if (!empty($_POST)) {
    ...
    if (!$response['valid']) {
        ...
        redirect('administration/modules/call_status/create.php');
    } else {
        $fields = array();
        ...
        $statusId = addNewCallStatusDetails($fields);

        redirect('administration/modules/call_status/view.php?id=' . $statusId);
    }
}